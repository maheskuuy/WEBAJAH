          ...
          <div class="container z-10">
            <div class="flex flex-wrap justify-center -mx-3">
              ...
              >
                ...
                <p class="text-white">
                  Bagi Pengguna Baru Silahkan Isikan Identitas Diri Anda
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <div class="flex-auto p-6">
                  <form action="{{ route('signup.create') }}" method="POST" role="form">
                      @csrf
                      <div class="mb-4">
                          <input
                              type="text"
                      ...
                      <p class="mt-4 mb-0 leading-normal text-sm">
                          Sudah Punya Akun?
                          <a href="{{ route('signin/signin') }}" class="font-bold text-slate-700">Sign in</a>
                      </p>
                  </form>
              </div>              
      </section>
